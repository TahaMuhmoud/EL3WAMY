  ...
  movies: [
    {
      ...
      href: "/EL3WAMY/movies/popular",
      icon: BiMoviePlay,
    },
    {
      name: "now playing",
      description: "Speak directly to your customers",
      href: "/EL3WAMY/movies/toprated",
      icon: BiMoviePlay,
    },
    {
      name: "upcoming",
      description: "Your customers’ data will be safe and secure",
      href: "/EL3WAMY/movies/nowplaying",
      icon: BiMoviePlay,
    },
    {
      name: "top rated",
      description: "Connect with third-party tools",
      href: "/EL3WAMY/movies/upcoming",
      icon: BiMoviePlay,
    },
  ],
  "tv-show": [
