  ...
  return (
    <section className="carousel sec-bg mx-auto w-full h-full text-white absolute inset-0 ">
      <img
        ...
        alt=""
        className="min-w-full min-h-full max-h-full absolute inset-0 -z-50 object-cover object-center"
      />
              ...
              indx === 0 ? (
                ...
                >
                  <img
                    ...
                    alt=""
                    className="min-w-full min-h-full max-w-full max-h-full inset-0 xl:object-cover object-center"
                  />
                  <Link
                    to={`/movie/${movie.id}`}
